...
contract PanDaoProviderModule is GelatoProviderModuleStandard {
  ...
  function isProvided(address _addressRequestingExecution, address, Task calldata)
    external
    view
    override
    returns(string memory isOk)
  {
    ...
    isOk = _addressRequestingExecution == storedInsurancePool ? "OK" : "InsurancePoolModule: Address is not InsurancePool";
  }
